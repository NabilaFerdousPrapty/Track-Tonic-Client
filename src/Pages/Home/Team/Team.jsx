      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          ...
          <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
           Our Specialized fitness trainers are here to help you reach your fitness goals.
           It doesn't matter if you're a beginner or a pro, we have a trainer for you.
           what are you waiting for? Start your fitness journey today.
          </p>
